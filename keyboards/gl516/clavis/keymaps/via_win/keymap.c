...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT(
  //.--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------.
              _______,            KC_1,            KC_2,            KC_3,            KC_4,            KC_5,           TG(1),         KC_MUTE,         KC_MPLY,            KC_6,            KC_7,            KC_8,            KC_9,            KC_0,         KC_BSPC,
  //|----------------+----------------+----------------+----------------+----------------+----------------+----------------+----------------+----------------+----------------+----------------+----------------+----------------+----------------+----------------|
  ...
  //|----------------+----------------+----------------+----------------+----------------+----------------+----------------+----------------+----------------+----------------+----------------+----------------+----------------+----------------+----------------|
              KC_HOME,                 LALT_T(KC_LANG2), LCTL_T(KC_BSPC),    LT(2,KC_SPC),                            KC_P0,          KC_DOT,         KC_COMM,                     LT(2,KC_SPC),  RCTL_T(KC_ENT),RGUI_T(KC_LANG1)
  //.--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------.
  ),
  [1] = LAYOUT(
  //.--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------.
